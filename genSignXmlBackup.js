...
const ts = formatDateToISOWithoutMilliseconds(new Date());
console.log(ts);
...
const esignXml = `
<Esign AuthMode="1" aspId="mQ3SY2lvVg9qUAauq9ztMACHMZwfDxym" ekycId="" ekycIdType="A" responseSigType="pkcs7" responseUrl="http://localhost:8080/esignAsp-0.0.1-SNAPSHOT/res/dummy@1@1" sc="Y" ts=${ts} txn=${uuidString} ver="2.1">
  <Docs>
...
fs.writeFileSync('tmp.xml', finalXml);
